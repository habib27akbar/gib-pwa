					...
					<div class="card-body">
						...
						<div class="contact-form">
							<div class="col-md-12 mb-4">
                                    ...
                                    <img src="https://ptgib.co.id/asset/img_agenda/{{ $berita->gambar }}" class="card-img-top" alt="${item.judul}" style="object-fit: cover;">
                                    <div class="card-body">
                                        <h5 class="card-title">{{ $berita->tema }}</h5>
                                        <div><?=$berita->isi_agenda?></div>
