...
function loadProducts(sort = 'newest', page = 1, search = '') {
    const apiUrl = `{{ url('/api/workshop') }}?sort=${sort}&page=${page}&search=${encodeURIComponent(search)}`;
    console.log(apiUrl);
        ...
        .then(data => {
            ...
            if (data.data.length > 0) {
                data.data.forEach(catalog => {
                    const assetPath = "https://ptgib.co.id/asset/img_workshop/";
                    const urlPath = "{{ url('/workshop/') }}";
                                ...
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="card-side-img d-flex">
                                            <!-- Gambar Utama -->
                                            ${catalog.gambar ? `
                                                <a class="product-thumbnail d-block me-2" href="${urlPath}/${catalog.id_workshop }/edit">
                                        ...
                                        <div class="card-content px-4 py-2">
                                            <a style="font-size:13px" href="${urlPath}/${catalog.id_workshop }/edit">
                                                ${catalog.judul}
