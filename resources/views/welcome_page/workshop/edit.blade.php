					...
					<div class="card-body">
						...
						<div class="contact-form">
							<div class="col-md-12 mb-4">
                                    ...
                                    <img src="https://ptgib.co.id/asset/img_workshop/{{ $workshop->gambar }}" class="card-img-top" alt="${item.judul}" style="object-fit: cover;">
                                    <div class="card-body">
                                        <h5 class="card-title">{{ $workshop->judul }}</h5>
                                        <div><?=$workshop->isi_workshop?></div>
                                        <?=$workshop->maps?>
