                        ...
                        <div class="container px-0">
                            ...
                            <div class="footer-nav position-relative">
                                ...
                                <ul class="h-100 d-flex align-items-center justify-content-between ps-0">
                                    ...
                                    <li class="{{ Request::is('welcome_page') ? 'active' : '' }}"><a href="{{ route('welcome_page.index') }}">
                                    ...
                                    <li><a href="{{ route('catalog_welcome.index') }}">
                                    ...
                                    <li><a href="{{ route('scan_produk.index') }}">
                                            ...
                                            </svg><span>Scan Produk</span></a></li>


                                    <li><a href="{{ route('login') }}">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="30" fill="currentColor" class="bi bi-door-open" viewBox="0 0 16 16">
